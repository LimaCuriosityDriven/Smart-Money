...
<main>
        ...
        <div class="form">
            <form action="Recebimentos" method="post" autocomplete="off" id="formReceita">
            	<input type ="hidden" name = "action" value = "editarrecebimento">
            	<input type = "hidden" name = "idrecebimento" value = "${recebimento.id_recebimento}">
                <!-- Coluna 1 -->
                <div class="col">
                    <div class="input-item">
                        <i class="ph ph-text-align-left"></i>
                        <input type="text" name="nomerecebimento" id="" value = "${recebimento.nm_recebimento}" required>
                    </div>
                    <div class="input-item">
                        <i class="ph ph-currency-circle-dollar"></i>
                        <input type="number" name="valorrecebimento" id="" value = "${recebimento.vl_recebimento }" min="0" required>
                    </div>
                    <div class="input-item">
                        ...
                        <div class="cl-toggle-switch">
                            <label class="cl-switch">
                                <input type="checkbox" name="statusrecebimento" value = "1" ${recebimento.st_recebimento == 1 ? 'checked' : ''}>
                                <span></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="input-item ">
                        <div class="col d-flex justify-content-between ">
                            ...
                            <input type="text" name="datarecebimento" value='<fmt:formatDate value="${recebimento.dt_recebimento}" pattern="dd/MM/yyyy"/>' required>
                        </div>
                    </div>
                                       <div class="input-item">
                        <i class="ph ph-files"></i>
                        <input type="text" name="descrecebimento" id="" value = "${recebimento.ds_recebimento}">
                    </div>
